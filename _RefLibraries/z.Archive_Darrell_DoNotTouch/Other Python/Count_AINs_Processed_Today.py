...
log_filenames = [
    ...
    'C:/Users/dwolfe/Documents/Kootenai_County_Assessor_CodeBase-1/Working_Darrell/Logs_Darrell/PlatMappingPacketsAutomation.log'
]

class AINLogProcessor_Week:
    def __init__(self, log_filenames, start_date=None, end_date=None):
        ...
        self.pattern = re.compile(r'(\d{4}-\d{2}-\d{2}) \d{2}:\d{2}:\d{2},\d{3} - INFO - Sent (?:AIN|DBAIN) (\d{6})')
...
if __name__ == "__main__":
    ...
    log_processor = AINLogProcessor_Week(log_filenames, start_date, end_date)
...
class AINLogProcessor_Today:
    def __init__(self, log_filenames):
        ...
        self.pattern = re.compile(r'Sent (?:AIN|DBAIN) (\d{6})')
...
if __name__ == "__main__":
    ...
    log_processor = AINLogProcessor_Today(log_filenames)
