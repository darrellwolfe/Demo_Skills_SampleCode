...
Declare @PrimaryTransferDateFROM date = CAST(CAST(@Year-3 as varchar) + '-01-01' AS DATE); -- Generates '2023-01-01' for the current year
...
AND (memo_text LIKE @MemoText1
    OR memo_text LIKE @MemoText2)
