...
def setup_logging():
    ...
    log_file = os.path.join(log_folder, 'MLS_MappingPacket_PLATs_AltVersion_NoDetails.log')
...
def on_submit():
    ...
    global AINFROM, PDESC, PFILE, PNUMBER, TREVIEW, MappingPacketType, InitialsTech, InitialsAppraiser, MemoTXT, ForYear, PLATCOMBO, LEGENDTYPE, AIN_Exclude
    ...
    MemoTXT = f"{InitialsTech}-{the_month}/{str(the_year)[-2:]} {MappingPacketType} from {AINFROM_str} into {PLATCOMBO} for {ForYear} - PostProcessingAudit"
