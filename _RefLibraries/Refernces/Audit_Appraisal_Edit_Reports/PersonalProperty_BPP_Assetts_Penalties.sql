...
--And pmd.lrsn = 511387
--And mppv.mScheduleName = '08'
--Group By pmd.lrsn
And (UPPER(mppv.mDescription) LIKE '%RETURN%'
    And UPPER(mppv.mDescription) LIKE '%NON%')
...
mAcquisitionDate,
mAcquisitionValue,
mAppraisedValuewOverrides,
SUM(mAcquisitionValue) AS SUM_AcquisitionValue,
SUM(mAppraisedValuewOverrides) AS SUM_AppraisedValue
From CTE_Assets
Group By Owner,AIN,PIN,mDescription,mAcquisitionDate,mAcquisitionValue,mAppraisedValuewOverrides
Order by Owner;
