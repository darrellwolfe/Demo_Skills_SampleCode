...
--Far more resource intensive, but you can search the entire database for a specific entry

DECLARE @SearchValue NVARCHAR(255) = 'YourSearchValue' -- Replace this with the value you want to search for
